...
#get_channeldetails(channel_id)    
    with open('C:/Users/ANSHIKA TANDON/Downloads/testchannel.csv', 'w',encoding="utf-8",newline='') as csvfile:
        ...
        filewriter.writerow([channel_id,channel_title_name,totalchannel_views_count,total_subscriber_count,total_video_count])
        print(f"File path: {'C:/Users/ANSHIKA TANDON/Downloads/testchannel.csv'}")
        print(f"Values: {channel_id}, {channel_title_name}, {totalchannel_views_count}, {total_subscriber_count}, {total_video_count}")
...
def get_playlistId(channel_id):
    ...
    while extra_pages_is_there:
        ...
        #print(playlist)    
        with open('C:\\Users\\ANSHIKA TANDON\\Downloads\\playlistid.csv', 'w',encoding="utf-8",newline='') as csvfile:
            ...
            for i in range(len(response['items'])):
                ...
                print(f"File path: {'C:/Users/ANSHIKA TANDON/Downloads/playlistid.csv'}")
                filewriter.writerow([channel_id,playlist_id,playlist_name])
...
def get_videodetails(playlist_id,videolist):
    ...
    file_exists = os.path.isfile('C:/Users/ANSHIKA TANDON/Downloads//video.csv')
    ...
    with open('C:/Users/ANSHIKA TANDON/Downloads//video.csv', 'a',encoding="utf-8",newline='') as csvfile:
            filewriter = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
            if not file_exists:
            ...
            for i in range(len(videolist)):
                ...
                print(f"File path: {'C:/Users/ANSHIKA TANDON/Downloads/video.csv'}")
for i in playlistId :
    youtube_videoId(i)
...
result.to_csv("C:/Users/ANSHIKA TANDON/Downloads\\secondleveljoin.csv",index = False)
# print(f"File path: {'C:/Users/ANSHIKA TANDON/Downloads\\secondleveljoin.csv'}")
